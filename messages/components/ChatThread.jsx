        ...
        <div className="shrink-0 px-4 py-2.5 bg-violet-50/70 dark:bg-violet-950/20 border-b border-violet-100 dark:border-violet-900/40">
          <div className="flex items-start gap-3">
            ...
            <div className="shrink-0 mt-0.5">
              ...
              {conv.category === "guests" && (
                <span className="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-1 rounded-full bg-violet-50 dark:bg-violet-950/40 text-violet-700 dark:text-violet-400 border border-violet-200/60 dark:border-violet-800/40">
