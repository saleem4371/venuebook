...
function FieldWrapper({ label, children, badge }) {
  return (
    <div className="space-y-1.5">
      <label className="flex flex-wrap items-center gap-x-2 gap-y-1 text-sm font-medium text-gray-700 dark:text-gray-300">
        {label}
        {badge && (
...
const inputClass =
  "w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-0 transition-shadow";
        ...
        <button
          ...
          className={`py-2.5 px-3 rounded-xl text-sm font-medium border transition-all ${
            value === s.id
              ...
              : "border-gray-200 dark:border-gray-700 text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 hover:border-gray-300"
          }`}
...
function FarmstayFields({ t, details, update, isGoldMember , booking , venueData }) {
  return (
    <>
      ...
      {isGoldMember && (
        <div className="flex items-center justify-between gap-3 p-4 rounded-xl bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800">
          <div className="min-w-0">
            <p className="text-sm font-medium text-yellow-800 dark:text-yellow-300 truncate">
              {t("early_checkin")}
            </p>
            <span className="inline-block mt-1 text-xs bg-yellow-200 dark:bg-yellow-800 text-yellow-800 dark:text-yellow-200 px-2 py-0.5 rounded-full">
...
function WorkspaceFields({ t, details, update }) {
  return (
    <>
      ...
      <div className="rounded-xl border border-gray-100 dark:border-gray-800 p-4 space-y-0 divide-y divide-gray-100 dark:divide-gray-800">
...
export default function BookingDetailsSection({
  ...
  return (
    ...
    >
      {/* Section header */}
      <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-100 dark:border-gray-800 flex items-center gap-3">
        <div
