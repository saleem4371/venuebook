...
const CATEGORY_PIN = {
  ...
  venue: {
    ...
    // Platform-standard Venue glyph — Lucide "building-2", mirrors CategoryNavigator VenueIcon
    renderIcon: () => (
      <>
        <path d="M10 12h4" />
        <path d="M10 8h4" />
  ...
  farmstay: {
    ...
    // Platform-standard Farmstay glyph — Lucide "tree-pine", mirrors CategoryNavigator FarmstayIcon
    renderIcon: () => (
      <>
