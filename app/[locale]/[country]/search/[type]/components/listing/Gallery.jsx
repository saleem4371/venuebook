...
export default function Gallery({ images, setOpen, openTour }) {
  ...
  return (
    <>
      {/* ── MOBILE SLIDER ──────────────────────────────────────────────────── */}
      {/*
        -mx-4 sm:-mx-6  breaks out of the page's px-4/px-6 container so the
        gallery bleeds to screen edges (edge-to-edge). No border-radius on mobile.
        touchAction "pan-y" allows vertical page scroll but we handle horizontal.
      */}
      <div
      ...
      >
        {/*
          Both enter and exit are absolute — they run simultaneously so the slide
          feels physical. No opacity change at any point.
        */}
